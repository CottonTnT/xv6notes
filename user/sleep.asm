...
int main(int argc, char* argv[])
{
  ...
  12:	7da50513          	addi	a0,a0,2010 # 7e8 <malloc+0xe8>
  16:	00000097          	auipc	ra,0x0
  1a:	62c080e7          	jalr	1580(ra) # 642 <printf>
        exit(0);
  1e:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b2:	46250513          	addi	a0,a0,1122 # 810 <digits>
 3b6:	883a                	mv	a6,a4
...
void vprintf(int fd, const char* fmt, va_list ap)
{
 ...
 47e:	396b8b93          	addi	s7,s7,918 # 810 <digits>
 ...
 5be:	24e90913          	addi	s2,s2,590 # 808 <malloc+0x108>
                while (*s != 0) {
...
free(void *ap)
{
 ...
 686:	1a67b783          	ld	a5,422(a5) # 828 <freep>
 ...
 6b4:	00e6ea63          	bltu	a3,a4,6c8 <free+0x50>
{
 ...
 6f6:	12f73b23          	sd	a5,310(a4) # 828 <freep>
}
 6fa:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 728:	10453503          	ld	a0,260(a0) # 828 <freep>
 ...
 750:	0dc90913          	addi	s2,s2,220 # 828 <freep>
  if(p == (char*)-1)
 754:	5afd                	li	s5,-1
 756:	a88d                	j	7c8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 758:	00000797          	auipc	a5,0x0
 75c:	0d878793          	addi	a5,a5,216 # 830 <base>
 760:	00000717          	auipc	a4,0x0
 764:	0cf73423          	sd	a5,200(a4) # 828 <freep>
 768:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 78a:	0aa73123          	sd	a0,162(a4) # 828 <freep>
      return (void*)(p + 1);
