...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	fe878793          	addi	a5,a5,-24 # 9040 <uninit>
      60:	0000b697          	auipc	a3,0xb
      64:	6f068693          	addi	a3,a3,1776 # b750 <buf>
    if(uninit[i] != '\0'){
...
00000000000001e4 <createtest>:
{
  ...
  name[0] = 'a';
     ...
     1f6:	d3678793          	addi	a5,a5,-714 # 7f28 <name>
  ...
  name[0] = 'a';
     ...
     238:	cf478793          	addi	a5,a5,-780 # 7f28 <name>
...
0000000000000278 <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     2b0:	4a4a0a13          	addi	s4,s4,1188 # b750 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2b4:	6b0d                	lui	s6,0x3
...
000000000000082e <writetest>:
{
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8cc:	e8858593          	addi	a1,a1,-376 # b750 <buf>
...
00000000000009ba <writebig>:
{
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9ea:	d6a90913          	addi	s2,s2,-662 # b750 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a3c:	d1890913          	addi	s2,s2,-744 # b750 <buf>
  if(fd < 0){
...
0000000000000b68 <unlinkread>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c10:	b4458593          	addi	a1,a1,-1212 # b750 <buf>
     c14:	8526                	mv	a0,s1
...
0000000000000d1e <linktest>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     de8:	96c58593          	addi	a1,a1,-1684 # b750 <buf>
...
badarg(char *s)
{
    ...
    1184:	35048493          	addi	s1,s1,848 # c350 <buf+0xc00>
...
00000000000011ba <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    1252:	dea78793          	addi	a5,a5,-534 # 8038 <big.1270>
    1256:	00008697          	auipc	a3,0x8
    125a:	de268693          	addi	a3,a3,-542 # 9038 <__global_pointer$+0x928>
      big[i] = 'x';
    ...
    1270:	dc078623          	sb	zero,-564(a5) # 9038 <__global_pointer$+0x928>
...
0000000000001746 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1792:	fc2a8a93          	addi	s5,s5,-62 # b750 <buf>
      if(cc > sizeof(buf))
    ...
    17b0:	fa470713          	addi	a4,a4,-92 # b750 <buf>
    ...
    180e:	f46b0b13          	addi	s6,s6,-186 # b750 <buf>
...
0000000000001f9a <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1fb6:	35098993          	addi	s3,s3,848 # c350 <buf+0xc00>
    1fba:	1003d937          	lui	s2,0x1003d
    1fbe:	090e                	slli	s2,s2,0x3
    1fc0:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002ed20>
    pid = fork();
...
0000000000002044 <bigargtest>:
{
  ...
  close(fd);
    ...
    20ac:	e9078793          	addi	a5,a5,-368 # 7f38 <args.1807>
    20b0:	00006697          	auipc	a3,0x6
    20b4:	f8068693          	addi	a3,a3,-128 # 8030 <args.1807+0xf8>
    ...
    20cc:	e7058593          	addi	a1,a1,-400 # 7f38 <args.1807>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2188:	0007c583          	lbu	a1,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff08a0>
...
0000000000002318 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2356:	6705                	lui	a4,0x1
      *b = 99;
    2358:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff18a0>
    for(b = a; b < a+TOOMUCH; b += 4096){
...
000000000000249e <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2500:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f189f>
  a = sbrk(0);
    2504:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    2564:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f189f>
...
0000000000002cdc <subdir>:
{
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2dc0:	99458593          	addi	a1,a1,-1644 # b750 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2dd6:	97e74703          	lbu	a4,-1666(a4) # b750 <buf>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2ea0:	8b458593          	addi	a1,a1,-1868 # b750 <buf>
...
0000000000003b58 <preempt>:
{
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3c56:	afe58593          	addi	a1,a1,-1282 # b750 <buf>
...
0000000000004002 <sharedfd>:
{
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4152:	fd2783e3          	beq	a5,s2,4118 <sharedfd+0x116>
      if(buf[i] == 'c')
    4156:	0007c703          	lbu	a4,0(a5) # 3e800000 <__BSS_END__+0x3e7f18a0>
...
00000000000041ba <fourfiles>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    425c:	4f8a0a13          	addi	s4,s4,1272 # b750 <buf>
    4260:	00007a97          	auipc	s5,0x7
    4264:	4f1a8a93          	addi	s5,s5,1265 # b751 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4362:	3f278793          	addi	a5,a5,1010 # b750 <buf>
...
0000000000004750 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4790:	fc490913          	addi	s2,s2,-60 # b750 <buf>
  for(i = 0; i < N; i++){
    4794:	4a51                	li	s4,20
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    47ee:	f6690913          	addi	s2,s2,-154 # b750 <buf>
  if(fd < 0){
...
0000000000004a26 <fsfull>:
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4a72:	ce2a0a13          	addi	s4,s4,-798 # b750 <buf>
    name[0] = 'f';
...
0000000000004bc6 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    4bda:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x187ead>
    4bde:	02f50533          	mul	a0,a0,a5
    4be2:	3c6ef7b7          	lui	a5,0x3c6ef
    4be6:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6e0bff>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5744:	7f07b783          	ld	a5,2032(a5) # 7f30 <freep>
    ...
    5772:	00e6ea63          	bltu	a3,a4,5786 <free+0x50>
{
  ...
  freep = p;
    ...
    57b4:	78f73023          	sd	a5,1920(a4) # 7f30 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    57e6:	74e53503          	ld	a0,1870(a0) # 7f30 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    580e:	72690913          	addi	s2,s2,1830 # 7f30 <freep>
  if(p == (char*)-1)
    5812:	5afd                	li	s5,-1
    5814:	a88d                	j	5886 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    5816:	00009797          	auipc	a5,0x9
    581a:	f3a78793          	addi	a5,a5,-198 # e750 <base>
    581e:	00002717          	auipc	a4,0x2
    5822:	70f73923          	sd	a5,1810(a4) # 7f30 <freep>
    ...
    5848:	6ea73623          	sd	a0,1772(a4) # 7f30 <freep>
      return (void*)(p + 1);
