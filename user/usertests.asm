...
00000000000011ba <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    1252:	dda78793          	addi	a5,a5,-550 # 8028 <big.1265>
    1256:	00008697          	auipc	a3,0x8
    125a:	dd268693          	addi	a3,a3,-558 # 9028 <__global_pointer$+0x928>
      big[i] = 'x';
    ...
    1270:	da078e23          	sb	zero,-580(a5) # 9028 <__global_pointer$+0x928>
...
0000000000002044 <bigargtest>:
{
  ...
  close(fd);
    ...
    20ac:	e8078793          	addi	a5,a5,-384 # 7f28 <args.1802>
    20b0:	00006697          	auipc	a3,0x6
    20b4:	f7068693          	addi	a3,a3,-144 # 8020 <args.1802+0xf8>
    ...
    20cc:	e6058593          	addi	a1,a1,-416 # 7f28 <args.1802>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5734:	7f07b783          	ld	a5,2032(a5) # 7f20 <freep>
    ...
    5762:	00e6ea63          	bltu	a3,a4,5776 <free+0x50>
{
  ...
  freep = p;
    ...
    57a4:	78f73023          	sd	a5,1920(a4) # 7f20 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    57d6:	74e53503          	ld	a0,1870(a0) # 7f20 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    57fe:	72690913          	addi	s2,s2,1830 # 7f20 <freep>
  if(p == (char*)-1)
    5802:	5afd                	li	s5,-1
    5804:	a88d                	j	5876 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    5806:	00009797          	auipc	a5,0x9
    580a:	f3a78793          	addi	a5,a5,-198 # e740 <base>
    580e:	00002717          	auipc	a4,0x2
    5812:	70f73923          	sd	a5,1810(a4) # 7f20 <freep>
    ...
    5838:	6ea73623          	sd	a0,1772(a4) # 7f20 <freep>
      return (void*)(p + 1);
