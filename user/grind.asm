...
go(int which_child)
{
  ...
  int fd = -1;
      ...
      sbrk(6011);
      fc:	6a85                	lui	s5,0x1
      fe:	77ba8a93          	addi	s5,s5,1915 # 177b <buf.1231+0x103>
    ...
    if(what == 1){
     ...
     396:	2e658593          	addi	a1,a1,742 # 1678 <buf.1231>
     39a:	854a                	mv	a0,s2
     ...
     3ae:	2ce58593          	addi	a1,a1,718 # 1678 <buf.1231>
     3b2:	854a                	mv	a0,s2
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    121a:	45a7b783          	ld	a5,1114(a5) # 1670 <freep>
    ...
    1248:	00e6ea63          	bltu	a3,a4,125c <free+0x50>
{
  ...
  freep = p;
    ...
    128a:	3ef73523          	sd	a5,1002(a4) # 1670 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    12bc:	3b853503          	ld	a0,952(a0) # 1670 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12e4:	39090913          	addi	s2,s2,912 # 1670 <freep>
  if(p == (char*)-1)
    12e8:	5afd                	li	s5,-1
    12ea:	a88d                	j	135c <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    12ec:	00000797          	auipc	a5,0x0
    12f0:	77478793          	addi	a5,a5,1908 # 1a60 <base>
    12f4:	00000717          	auipc	a4,0x0
    12f8:	36f73e23          	sd	a5,892(a4) # 1670 <freep>
    ...
    131e:	34a73b23          	sd	a0,854(a4) # 1670 <freep>
      return (void*)(p + 1);
