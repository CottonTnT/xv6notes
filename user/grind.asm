...
go(int which_child)
{
  ...
  int fd = -1;
      ...
      sbrk(6011);
      fc:	6a85                	lui	s5,0x1
      fe:	77ba8a93          	addi	s5,s5,1915 # 177b <buf.1236+0xf3>
    ...
    if(what == 1){
     ...
     396:	2f658593          	addi	a1,a1,758 # 1688 <buf.1236>
     39a:	854a                	mv	a0,s2
     ...
     3ae:	2de58593          	addi	a1,a1,734 # 1688 <buf.1236>
     3b2:	854a                	mv	a0,s2
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    122a:	45a7b783          	ld	a5,1114(a5) # 1680 <freep>
    ...
    1258:	00e6ea63          	bltu	a3,a4,126c <free+0x50>
{
  ...
  freep = p;
    ...
    129a:	3ef73523          	sd	a5,1002(a4) # 1680 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    12cc:	3b853503          	ld	a0,952(a0) # 1680 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12f4:	39090913          	addi	s2,s2,912 # 1680 <freep>
  if(p == (char*)-1)
    12f8:	5afd                	li	s5,-1
    12fa:	a88d                	j	136c <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    12fc:	00000797          	auipc	a5,0x0
    1300:	77478793          	addi	a5,a5,1908 # 1a70 <base>
    1304:	00000717          	auipc	a4,0x0
    1308:	36f73e23          	sd	a5,892(a4) # 1680 <freep>
    ...
    132e:	34a73b23          	sd	a0,854(a4) # 1680 <freep>
      return (void*)(p + 1);
