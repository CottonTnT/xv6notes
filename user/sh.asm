...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1196:	2de7b783          	ld	a5,734(a5) # 1470 <freep>
    ...
    11c4:	00e6ea63          	bltu	a3,a4,11d8 <free+0x50>
{
  ...
  freep = p;
    ...
    1206:	26f73723          	sd	a5,622(a4) # 1470 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1238:	23c53503          	ld	a0,572(a0) # 1470 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1260:	21490913          	addi	s2,s2,532 # 1470 <freep>
  if(p == (char*)-1)
    1264:	5afd                	li	s5,-1
    1266:	a88d                	j	12d8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    1268:	00000797          	auipc	a5,0x0
    126c:	27878793          	addi	a5,a5,632 # 14e0 <base>
    1270:	00000717          	auipc	a4,0x0
    1274:	20f73023          	sd	a5,512(a4) # 1470 <freep>
    ...
    129a:	1ca73d23          	sd	a0,474(a4) # 1470 <freep>
      return (void*)(p + 1);
