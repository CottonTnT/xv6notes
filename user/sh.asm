...
0000000000000a60 <main>:
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9c:	9d048493          	addi	s1,s1,-1584 # 1468 <buf.1133>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	9c3a0a13          	addi	s4,s4,-1597 # 146b <buf.1133+0x3>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b36:	93650513          	addi	a0,a0,-1738 # 1468 <buf.1133>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1186:	2de7b783          	ld	a5,734(a5) # 1460 <freep>
    ...
    11b4:	00e6ea63          	bltu	a3,a4,11c8 <free+0x50>
{
  ...
  freep = p;
    ...
    11f6:	26f73723          	sd	a5,622(a4) # 1460 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1228:	23c53503          	ld	a0,572(a0) # 1460 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1250:	21490913          	addi	s2,s2,532 # 1460 <freep>
  if(p == (char*)-1)
    1254:	5afd                	li	s5,-1
    1256:	a88d                	j	12c8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    1258:	00000797          	auipc	a5,0x0
    125c:	27878793          	addi	a5,a5,632 # 14d0 <base>
    1260:	00000717          	auipc	a4,0x0
    1264:	20f73023          	sd	a5,512(a4) # 1460 <freep>
    ...
    128a:	1ca73d23          	sd	a0,474(a4) # 1460 <freep>
      return (void*)(p + 1);
